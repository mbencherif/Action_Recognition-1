...
def parse_opts():
    ...
    parser.add_argument('--video_path', default='/content/RWF_2000/frames', type=str, help='Directory path of Videos')
    parser.add_argument('--annotation_path', default='/content/Action_Recognition/annotation_RWF/RWF-2000.json', type=str, help='Annotation file path')
    ...
    parser.add_argument('--n_classes', default=2, type=int, help='Number of classes (activitynet: 200, kinetics: 400, ucf101: 101, hmdb51: 51)')
    ...
    parser.add_argument('--pretrain_path', default='/content/Action_Recognition/weights/x3d_multigrid_kinetics_rgb_sgd_204000.pt', type=str, help='Pretrained model (.pth)')
    ...
    parser.add_argument('--model', default='x3d', type=str, help='(resnet | preresnet | wideresnet | resnext | densenet | ')
